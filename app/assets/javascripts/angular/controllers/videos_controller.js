...
videosController.controller('mostPopularVideosCtrl', ['$scope','$location', '$routeParams',
	'$http', '$sce', function($scope, $location, $routeParams, $http, $sce) {
		...
		$routeParams["page_token"] ? $scope.url = '/videos/'+$routeParams["page_token"]+'/results.json' : $scope.url = '/videos/results.json';
		...
		$scope.goPrevPage = function() {
			$scope.prevPageToken != null ? $location.path('videos/'+$scope.prevPageToken) : null;
		};

		$scope.goNextPage = function() {
			$scope.nextPageToken != null ? $location.path('videos/'+$scope.nextPageToken) : null;
		};
